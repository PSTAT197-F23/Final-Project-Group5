...
Before that though, lets take a look at our data when plotted on these axes:
...
K-means clustering works by repeatedly calculating the "mean" of each cluster, then assigning each data point to the closest "mean", repeating until the means/centroids no longer change.
